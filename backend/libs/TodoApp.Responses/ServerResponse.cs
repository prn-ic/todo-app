...
namespace TodoApp.Responses
{
    ...
    public class ServerResponse
    {
        ...
        /// <param name="message">The returns message status</param>
        /// <returns>IActionResult</returns>
        public static IActionResult BadRequestResult<T>(
            T error,
        ...
        public static IActionResult NotFoundResult(
            string message = "Object not found. See error for additional info"
        ...
        /// <param name="message">The returns message status</param>
        /// <returns>IActionResult</returns>
        public static IActionResult UnauthorizedResult<T>(
            T error,
        ...
        /// <param name="message">The returns message status</param>
        /// <returns>IActionResult</returns>
        public static IActionResult NotFoundResult<T>(
            T error,
            string message = "Object not found. See error for additional info"
        ) => ResponseResult.ClientErrorResult((int)ClientErrorCodes.NotFound, message, error);
        ...
        public static IActionResult RequestTimeoutResult() =>
            ResponseResult.ClientErrorResult(
                (int)ClientErrorCodes.Timeout,
